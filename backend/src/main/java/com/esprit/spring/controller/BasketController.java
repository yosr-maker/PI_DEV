...
public class BasketController {
	...
	@GetMapping("/SommeDeMesAchats/{id}")
	@ResponseBody
	public float SommeDeMesAchats(@PathVariable("id")Long id){
		return basketService.SommeDeMesAchats(id);
	...
	public String affecterBasketToClient(@PathVariable("idb")Long idb, @PathVariable("idc")Long idc) {
		return basketService.affecterBasketToClient(idb, idc);
		
	}
	@GetMapping("/findBasket/{idb}")
	@ResponseBody
	public Basket findBasket(@PathVariable("idb")Long basketId) {
		return basketService.findBasket(basketId);
		
	}
	//ok
	@GetMapping("/affecterFactoBasket/{idf}/{idb}")
	@ResponseBody
	public String affecterFactToBasket(@PathVariable("idf")Long idf,@PathVariable("idb")Long idb) {
		return basketService.affecterFactToBasket(idf, idb);
